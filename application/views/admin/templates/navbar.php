            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <h4 class="breadcrumb-item text-2xl"><a class="opacity-5 text-white" href="javascript:;">Pages</a></h4>
                        <h4 class="breadcrumb-item text-white text-bold active text-2xl" aria-current="page"><?= $title ?></h4>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0 mt-2">Dashboard</h6>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex mx-3"> 
                            <a href="<?= site_url('admin/login/logout') ?>" class="btn-green btn-group" 
                            onclick="return confirm('Apakan yakin ingin keluar ?')">
