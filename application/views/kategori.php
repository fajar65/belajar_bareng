        ...
        <div class="container">
            <div class="container-banner">
                ...
                <div class="main_title centered align-items-center text-center p-4">
                    <h2 class="mb-3 title-kelas bg-green" style="color: #00FF84;">Kelas <?php foreach ($kategoriKelas2 as $kl) { ?> <?= $kl->nama_kategori ?> <?php } ?></h2>
                    <p>
            ...
            <div class="justify-content-between mb-4">
                <div class="row align-content-center align-items-center">
                    <div class="col">
                        <h4>Daftar Kelas <?php foreach ($kategoriKelas2 as $kl) { ?> <?= $kl->nama_kategori ?> <?php } ?> </h4>
                    </div>
                    <!-- <div class="col"> -->
                    <div class="col-lg-4">
                        <!-- <h4>Cari Kelas</h4> -->
